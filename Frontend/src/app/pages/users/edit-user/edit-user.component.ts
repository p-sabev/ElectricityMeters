...
export class EditUserComponent {
  ...
  initEditForm() {
    ...
    this.editForm = new FormGroup({
      ...
      name: new FormControl<string>(this.userToEdit?.name ? this.userToEdit.name : '', [Validators.required, Validators.maxLength(250)]),
      middleName: new FormControl<string>(this.userToEdit?.middleName ? this.userToEdit.middleName : '', [Validators.maxLength(250)]),
      lastName: new FormControl<string>(this.userToEdit?.lastName ? this.userToEdit.lastName : '', [Validators.maxLength(250)]),
      email: new FormControl<string>(this.userToEdit?.email ? this.userToEdit.email : '', [Validators.maxLength(250)]),
      userName: new FormControl<string>(this.userToEdit?.userName ? this.userToEdit.userName : '', [Validators.maxLength(250)]),
