...
import { AddReadingForSwitchboardComponent } from '../readings/add-reading-for-switchboard/add-reading-for-switchboard.component';
...
import { DisplayTwoThreePhaseReadingComponent } from '../readings/display-two-three-phase-reading/display-two-three-phase-reading.component';
...
export class SwitchboardsComponent implements OnInit {
  ...
  deleteSwitchboard(switchboard: Switchboard) {
    this.switchboardsService
      .deleteSwitchboard(switchboard.id)
      .pipe(
        tap(() => {
