...
@Component({
  ...
  standalone: true,
  imports: [FaIconComponent, FormErrorsComponent, NgForOf, NgIf, ReactiveFormsModule, TranslateModule],
...
export class AddEditSwitchboardComponent implements OnInit {
  ...
  initAddEditForm() {
    this.addEditForm = new FormGroup({
      ...
      name: new FormControl<string>(this.switchboardToEdit?.name ? this.switchboardToEdit.name : '', [
        Validators.required,
